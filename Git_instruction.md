...
Посмотреть список веток в репозитории и узнатьь, с какой из них вы работаете в данный момент, можно с помощью команды

```
git branch
```

Текущая ветка, с которой вы в настоящий момент производите изменения, будет отмечена звездочкой : ***master***. Так же текущую ветку можно увидеть в интерфейсе VS Code в левом нижнем углу:
