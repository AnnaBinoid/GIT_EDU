...
После успешного удаления ветки, в терминале возникнет надпись: 

*Deleted branch BranchName (was 493fd31)*. Благодаря указанному в скобках хэшкоду можно восстановить удаленную ветку. Для этого достаточно набрать в терминале команду
...
## 13. Консольные команды по работе с папками и файлами в VS Code
