...
Остается только выбрать приемлемый вариант.

Git не даст удалить ветку, если не было выполнено слияние.
Если информация в новой ветке не сохранена, ВОТ СЕЙЧАС МЫ И ПРОВЕРИМ, ЧТО БУДЕТ! И ЕЩЁ РАЗОК!!!
